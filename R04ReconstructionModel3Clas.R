...
# closely as possible for classification models                                #
################################################################################
...
DataGeorgeDixitCon <- data.frame(DataGeorgeDixit)
for(i in 1:nrow(DataGeorgeDixit)){if(DataGeorgeDixit$PFBS[i]>0){DataGeorgeDixit$PFBS[i]<-1}}
for(i in 1:nrow(DataGeorgeDixit)){if(DataGeorgeDixit$PFHpA[i]>0){DataGeorgeDixit$PFHpA[i]<-1}}
for(i in 1:nrow(DataGeorgeDixit)){if(DataGeorgeDixit$PFHxA[i]>0){DataGeorgeDixit$PFHxA[i]<-1}}
for(i in 1:nrow(DataGeorgeDixit)){if(DataGeorgeDixit$PFHxS[i]>0){DataGeorgeDixit$PFHxS[i]<-1}}
for(i in 1:nrow(DataGeorgeDixit)){if(DataGeorgeDixit$PFOA[i]>0){DataGeorgeDixit$PFOA[i]<-1}}
for(i in 1:nrow(DataGeorgeDixit)){if(DataGeorgeDixit$PFOA_PFOS_[i]>0){DataGeorgeDixit$PFOA_PFOS_[i]<-1}}
for(i in 1:nrow(DataGeorgeDixit)){if(DataGeorgeDixit$PFOS[i]>0){DataGeorgeDixit$PFOS[i]<-1}}
for(i in 1:nrow(DataGeorgeDixit)){if(DataGeorgeDixit$Total_PFAS[i]>0){DataGeorgeDixit$Total_PFAS[i]<-1}}
DataGeorgeDixit$PFBS <- as.factor(DataGeorgeDixit$PFBS)
DataGeorgeDixit$PFHpA <- as.factor(DataGeorgeDixit$PFHpA)
DataGeorgeDixit$PFHxA <- as.factor(DataGeorgeDixit$PFHxA)
DataGeorgeDixit$PFHxS <- as.factor(DataGeorgeDixit$PFHxS)
DataGeorgeDixit$PFOA <- as.factor(DataGeorgeDixit$PFOA)
DataGeorgeDixit$PFOA_PFOS_ <- as.factor(DataGeorgeDixit$PFOA_PFOS_)
DataGeorgeDixit$PFOS <- as.factor(DataGeorgeDixit$PFOS)
DataGeorgeDixit$Total_PFAS <- as.factor(DataGeorgeDixit$Total_PFAS)
# 0.5 Convert categorical variables into factors -------------------------------
...
# 0.6 Delete rows with NaNs ----------------------------------------------------
DataGeorgeDixit <- na.omit(DataGeorgeDixit)
###### 1. TUNE RANDOM FORESTS (BINARY CLASSIFICATION) ##########################
